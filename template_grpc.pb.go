...
type TemplateClient interface {
	Render(ctx context.Context, in *RenderRequest, opts ...grpc.CallOption) (*Rendered, error)
}
...
func (c *templateClient) Render(ctx context.Context, in *RenderRequest, opts ...grpc.CallOption) (*Rendered, error) {
	out := new(Rendered)
	err := c.cc.Invoke(ctx, "/puzzletemplateservice.Template/Render", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTemplateServer) Render(context.Context, *RenderRequest) (*Rendered, error) {
...
func _Template_Render_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/puzzletemplateservice.Template/Render",
	}
...
var Template_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "puzzletemplateservice.Template",
